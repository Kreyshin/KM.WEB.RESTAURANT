  ...
  },
  {
    ...
    children: [
      ...
      { path: 'configuracion', redirect: { name: 'config-empresa' } },
      {
        ...
        name: 'config-empresa',
        component: () => import('@/views/configuracion/EmpresaView.vue'),
        meta: { titulo: 'Empresa', roles: ['admin'] },
      },
      {
        path: 'configuracion/locales',
        name: 'config-locales',
        component: () => import('@/views/configuracion/LocalesView.vue'),
        meta: { titulo: 'Locales', roles: ['admin'] },
      },
      {
        path: 'configuracion/impuestos',
        name: 'config-impuestos',
        component: () => import('@/views/configuracion/ImpuestosView.vue'),
        meta: { titulo: 'Impuestos y cargos', roles: ['admin'] },
      },
      {
        path: 'configuracion/medios-pago',
        name: 'config-medios-pago',
        component: () => import('@/views/configuracion/MediosPagoView.vue'),
        meta: { titulo: 'Medios de pago', roles: ['admin'] },
      },
      {
